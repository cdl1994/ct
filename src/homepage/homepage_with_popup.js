    ...
    render() {
        ...
        <div>
            ...
            <div id="formnewsletter_pop">
                ...
                <button className="submitemail" id="submitNewsletter_pop"><img src="/image/catalog/default/misc/arrow-right.png" alt="right arrow" className="arrow-right-submit" /></button>
