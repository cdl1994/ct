...
class MyColorPicker extends Component {
  ...
  render() {
    return (
      <div>
      <div>
        <img class="color-image" ref="image" src='/image/data/custom-tobacco/colormap.gif' useMap='colormap' alt='colormap' />
    ...
    <div id="shadediv">
      <table id="shade">
        <tbody>
          <tr height="25px">
          <td id="b5" class="shadeblock ffffff" ></td>
          <td id="b4" class="shadeblock ffffff" ></td>
          <td id="b3" class="shadeblock ffffff" ></td>
          <td id="b2" class="shadeblock ffffff" ></td>
          <td id="b1" class="shadeblock ffffff" ></td>
          <td id="b0" class="shadeselect ffffff" ></td>
          <td id="b-1" class="shadeblock ffffff" ></td>
          <td id="b-2" class="shadeblock ffffff" ></td>
          <td id="b-3" class="shadeblock ffffff" ></td>
          <td id="b-4" class="shadeblock ffffff" ></td>
          <td id="b-5" class="shadeblock ffffff" ></td>
          </tr>
        </tbody>
      </table>
    </div>
